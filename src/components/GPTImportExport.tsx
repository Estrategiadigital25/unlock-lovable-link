...
import { Download, Upload, FileText, Package, AlertCircle, CheckCircle, X, File } from 'lucide-react';
import { 
  CustomGPT, 
  exportCustomGPT, 
  exportAllCustomGPTs, 
  ...
  const handleImport = async () => {
    if (!importText.trim()) {
      toast({
        ...
        description: "Ingresa datos JSON o selecciona un archivo",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      setImportResults([{
        success: false,
        message: 'Formato de archivo no válido. Debe ser un GPT individual o una colección de GPTs.',
        type: 'error'
      }]);
      ...
      <Dialog open={isImportOpen} onOpenChange={setIsImportOpen}>
        ...
        <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            {/* Text Input */}
            <div className="space-y-2">
              <Label>O pegar datos JSON</Label>
              <Textarea
                value={importText}
